...
def find_llama_classes_with_from_pretrained(module: ModuleType) -> List[Type[Any]]:
    ...
    for name, obj in inspect.getmembers(module):
        ...
        if hasattr(obj, 'from_pretrained') and isinstance(getattr(obj, 'from_pretrained'), classmethod):
            classes.append(obj)
            ...
            try:
                ...
                def patched_llama_from_pretrained(cls, repo_id, *, filename=None, **kwargs):
                    ...
                    if isinstance(repo_id, str) and repo_id.startswith("ipfs://"):
                        ...
                        return original_from_pretrained.__func__(cls, local_path, filename=None, **kwargs)
                    
                    # Otherwise, use the original method
                    return original_from_pretrained.__func__(cls, repo_id, filename=filename, **kwargs)
