...
def apply_patch():
    ...
    try:
        ...
        def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs):
            ...
            """
            if isinstance(pretrained_model_name_or_path, str) and pretrained_model_name_or_path.startswith('ipfs://'):
                ...
                model_path = os.path.join(local_path, os.path.basename(pretrained_model_name_or_path))
